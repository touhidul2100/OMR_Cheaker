...
imgArray = [[img, imgGray, imgBlur, imgCanny],
            [imgDisplayContours, imgWarpColored, imgWarpGray, imgThresh]]

# Create the stacked image using the stackImages function
stacked_img = utils.stackImages(imgArray, scale=0.5)
cv2.imshow("Stages of OMR Processing", stacked_img)
cv2.waitKey(0)